...
const handler = async (m, { conn, text, usedPrefix, command }) => {
 if (!text) throw `_*< DOWNLOADER - SPOTIFY />*_\n\n*[ ℹ️ ] Judul lagu Spotify diperlukan.*`;
  m.reply(global.wait);
  try {
    ...
    let spotifyi = ` _*< DOWNLOADER - SPOTIFY />*_\n\n`
        spotifyi += ` ▢ *Title:* ${spty.title}\n\n`
        spotifyi += ` ▢ *Artist:* ${spty.artist}\n\n`
        spotifyi += ` ▢ *Album:* ${spty.album}\n\n`                 
        spotifyi += ` ▢ *Published:* ${spty.year}\n\n`   
        spotifyi += `*[ ℹ️ ] Audio sedang dikirim. Tunggu...*`
