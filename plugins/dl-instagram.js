...
const handler = async (m, {conn, args, command, usedPrefix}) => {
  if (!args[0]) throw `_*< DOWNLOADER - INSTAGRAM />*_\n\n*[ ℹ️ ] Masukkan tautan Instagram.*`;
  m.reply(global.wait);
  try {
...
for (let i = 0; i < img.length; i++) {
  ...
  try {
    ...
    for (const urRRl of datTa) {
      ...
      const tXXxt = `_*< DOWNLOADER - INSTAGRAM />*_\n\n▢ *URL:* _${shortUrRRl}_`.trim();
